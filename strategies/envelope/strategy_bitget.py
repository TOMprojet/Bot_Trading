...
initial_balance = balance  # Assurez-vous de définir cette valeur lors du démarrage du bot
stop_loss_value = initial_balance * 0.5  # 50% du capital initial

# Vérifier si le stop loss doit être déclenché
if balance <= stop_loss_value:
